...
This file is the quick-reference operating contract for rmcp-kotlin. The longer
...
rmcp-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rmcp`](https://crates.io/crates/rmcp). Upstream Rust is the behavioral oracle while the
