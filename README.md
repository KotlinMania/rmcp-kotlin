# rmcp-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Frmcp--kotlin-blue.svg)](https://github.com/KotlinMania/rmcp-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/rmcp-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/rmcp-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/rmcp-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/rmcp-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`modelcontextprotocol/rust-sdk`](https://github.com/modelcontextprotocol/rust-sdk/).

**Original Project:** This port is based on [`modelcontextprotocol/rust-sdk`](https://github.com/modelcontextprotocol/rust-sdk/). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `modelcontextprotocol/rust-sdk`

> The text below is reproduced and lightly edited from [`https://github.com/modelcontextprotocol/rust-sdk/`](https://github.com/modelcontextprotocol/rust-sdk/). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
- [rmcp](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/crates/rmcp): The core crate providing the RMCP protocol implementation - see [rmcp](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/crates/rmcp/README.md)
- [rmcp-macros](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/crates/rmcp-macros): A procedural macro crate for generating RMCP tool implementations - see [rmcp-macros](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/crates/rmcp-macros/README.md)
...
You can easily build a service by using [`ServerHandler`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/crates/rmcp/src/handler/server.rs) or [`ClientHandler`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/crates/rmcp/src/handler/client.rs).
...
See [`crates/rmcp-macros`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/crates/rmcp-macros/README.md) for full macro documentation.
...
**Example:** [`examples/servers/src/common/calculator.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/servers/src/common/calculator.rs) (server), [`examples/servers/src/calculator_stdio.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/servers/src/calculator_stdio.rs) (stdio runner)
...
**Example:** [`examples/servers/src/common/counter.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/servers/src/common/counter.rs) (server), [`examples/clients/src/everything_stdio.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/clients/src/everything_stdio.rs) (client)
...
**Example:** [`examples/servers/src/prompt_stdio.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/servers/src/prompt_stdio.rs) (server), [`examples/clients/src/everything_stdio.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/clients/src/everything_stdio.rs) (client)
...
**Example:** [`examples/servers/src/sampling_stdio.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/servers/src/sampling_stdio.rs) (server), [`examples/clients/src/sampling_stdio.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/clients/src/sampling_stdio.rs) (client)
...
**Example:** [`examples/servers/src/completion_stdio.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/servers/src/completion_stdio.rs)
...
**Example:** [`examples/servers/src/common/progress_demo.rs`](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/servers/src/common/progress_demo.rs)
...
See [examples](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/examples/README.md).

## OAuth Support

See [Oauth_support](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/docs/OAUTH_SUPPORT.md) for details.
...
See [docs/CONTRIBUTE.MD](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/docs/CONTRIBUTE.MD) to get some tips for contributing.

### Using Dev Container

If you want to use dev container, see [docs/DEVCONTAINER.md](https://github.com/modelcontextprotocol/rust-sdk/blob/HEAD/docs/DEVCONTAINER.md) for instructions on using Dev Container for development.
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`modelcontextprotocol/rust-sdk`](https://github.com/modelcontextprotocol/rust-sdk/). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the rust-sdk authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`modelcontextprotocol/rust-sdk`](https://github.com/modelcontextprotocol/rust-sdk/) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
