...
kotlin {
    ...
    swiftExport {
        moduleName = "Rmcp"
        flattenPackage = "io.github.kotlinmania.rmcp"
    }

    android {
        namespace = "io.github.kotlinmania.rmcp"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rmcp-kotlin", version.toString())

    pom {
        name.set("rmcp-kotlin")
        description.set("Kotlin Multiplatform port of modelcontextprotocol/rust-sdk - Rust SDK for Model Context Protocol")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rmcp-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rmcp-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rmcp-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rmcp-kotlin.git")
        }
    }
}
...
val codeqlSerializationPlugin: Configuration by configurations.creating {
    description = "Kotlin serialization compiler plugin for CodeQL extraction"
    isCanBeResolved = true
    isCanBeConsumed = false
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    inputs.files(codeqlSerializationPlugin).withNormalizer(ClasspathNormalizer::class.java)
    ...
    doFirst {
        ...
        val serializationPluginJar = codeqlSerializationPlugin.singleFile.absolutePath
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.rmcp.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRmcpXCFramework",
    "assembleRmcpDebugXCFramework",
    "assembleRmcpReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRmcpXCFramework",
    "assembleReleaseIosFatFrameworkForRmcpXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRmcpXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRmcpXCFramework",
    "assembleDebugMacosFatFrameworkForRmcpXCFramework",
    "assembleReleaseMacosFatFrameworkForRmcpXCFramework",
    "assembleDebugTvosFatFrameworkForRmcpXCFramework",
    "assembleReleaseTvosFatFrameworkForRmcpXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRmcpXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRmcpXCFramework",
    "assembleDebugWatchosFatFrameworkForRmcpXCFramework",
    "assembleReleaseWatchosFatFrameworkForRmcpXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRmcpXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRmcpXCFramework",
